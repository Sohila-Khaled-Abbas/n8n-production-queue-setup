...
gh repo edit "$GITHUB_USER/n8n-workflow-gourmet-bistro-customer-service" --add-topic n8n --add-topic n8n-workflow --add-topic langchain --add-topic multi-agent --add-topic rag --add-topic qdrant --add-topic telegram-bot --add-topic supabase --add-topic software-engineering 2>$null
...
gh repo edit "$GITHUB_USER/n8n-workflow-upwork-ai-proposal-creator" --add-topic n8n --add-topic n8n-workflow --add-topic apify --add-topic web-scraping --add-topic openai --add-topic gpt-4 --add-topic proposal-generator --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-emaar-towers-lead-qualification" --add-topic n8n --add-topic n8n-workflow --add-topic lead-qualification --add-topic crm-automation --add-topic openrouter --add-topic telegram-bot --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-delivery-telegram-bot" --add-topic n8n --add-topic n8n-workflow --add-topic telegram-bot --add-topic mssql --add-topic conversational-commerce --add-topic session-persistence --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-apple-rag-chatbot-v2" --add-topic n8n --add-topic n8n-workflow --add-topic rag --add-topic qdrant --add-topic openai-embeddings --add-topic vector-database --add-topic ai-agent --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-daily-viral-content-radar" --add-topic n8n --add-topic n8n-workflow --add-topic content-curation --add-topic trend-analysis --add-topic etl-pipeline --add-topic http-api --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-telegram-notion-etl" --add-topic n8n --add-topic n8n-workflow --add-topic telegram-bot --add-topic notion-api --add-topic etl-pipeline --add-topic knowledge-management --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-gdrive-pdf-qdrant-indexer" --add-topic n8n --add-topic n8n-workflow --add-topic google-drive-api --add-topic qdrant --add-topic pdf-parser --add-topic rag --add-topic vector-embeddings --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-sentiment-analysis-agent" --add-topic n8n --add-topic n8n-workflow --add-topic sentiment-analysis --add-topic customer-feedback --add-topic nlp --add-topic crm-automation --add-topic software-engineering 2>$null
git push -u origin main
...
gh repo edit "$GITHUB_USER/n8n-workflow-gpt-oss-20b-huggingface" --add-topic n8n --add-topic n8n-workflow --add-topic huggingface --add-topic open-source-llm --add-topic cloud-inference --add-topic error-handling --add-topic software-engineering 2>$null
git push -u origin main
