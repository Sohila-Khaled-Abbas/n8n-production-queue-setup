                ...
                try:
                    ...
                    for node in nodes:
                        ...
                        if (
                            ...
                            triggers.append(
                                {"name": node.get("name"), "type": clean_type}
                            )
                    ...
                    if not triggers:
                        for node in nodes:
                            if (
                                "manual" in node.get("type", "").lower()
                                or "onclickingexecute" in node.get("type", "").lower()
                            ):
                                triggers.append(
                                    {"name": node.get("name"), "type": "Manual"}
                                )
                    ...
                    compiled_workflows.append(
                        {
                            ...
                            or f"Automated workflow containing {node_count} nodes.",
