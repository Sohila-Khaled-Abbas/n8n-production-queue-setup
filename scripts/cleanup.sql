...
-- Mark zombie executions as crashed (already done, but idempotent)
UPDATE execution_entity SET status = 'crashed' WHERE id IN (1209, 2310, 2311) AND status IN ('running', 'waiting', 'new');
